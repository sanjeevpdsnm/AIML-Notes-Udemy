...
# installed.
TCL_PREFIX='S:/notes/venv\Library'

# Top-level directory in which Tcl's platform-specific files (e.g.
# executables) are installed.
TCL_EXEC_PREFIX='S:/notes/venv\Library\bin'
...
# String to pass to linker to pick up the Tcl library from its
# installed directory.
TCL_LIB_SPEC='S:/notes/venv\Library\lib\tcl86t.lib'

# String to pass to the compiler so that an extension can
# find installed Tcl headers.
TCL_INCLUDE_SPEC='-IS:/notes/venv\Library\include'
...
TCL_PACKAGE_PATH='S:/notes/venv\Library\lib'
...
# String to pass to linker to pick up the Tcl stub library from its
# installed directory.
TCL_STUB_LIB_SPEC='-LS:/notes/venv\Library\lib tclstub86.lib'
...
TCL_STUB_LIB_PATH='S:/notes/venv\Library\lib\tclstub86.lib'
